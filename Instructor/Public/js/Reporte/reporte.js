...
$(document).ready(function(){
  ...
  $(".btnInventariosAmbiente").click(function () {
    ...
    if (filtro == null) {
    	...
    	mostrarLimitadoElementoPorIDAJAX(id,filtro);
    }
  ...
  $(".btnInventariosInstructor").click(function () {
     ...
     if (filtro == null) {
      ...
      mostrarLimitadoElementoPorIDAJAXInstructor(id,filtro);
    }
  });
...
function mostrarLimitadoElementoPorIDAJAX(id, filtro){
       // alert('entra a la funcion');
       try {
       	var dt = id;
       	var at = filtro;
    ...
    function mostrarLimitadoElementoPorIDAJAXInstructor(id, filtro){
       // alert('entra a la funcion');
       try {
        var dt = id;
        var at = filtro;
