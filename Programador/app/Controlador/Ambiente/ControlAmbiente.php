...
public function mostrarAmbienteEspecificoControl() {
     if ($_SERVER['REQUEST_METHOD'] == 'POST' &&
      ...
      !empty($_POST['detalleClasesU'])) {
		...
		echo "<script>console.log('no Entro a ningun if');</script>";
}
          ...
          #echo "<script>alert('Entro al controlador')</script>";
            ...
            ////////////////////
             ...
             public function mostrarmaterial($id) {
                $material = ModeloAmbiente::mostrarmaterial($id);
                return $material;
              }
