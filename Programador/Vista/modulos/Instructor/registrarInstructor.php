 ...
 ?>
    ...
    <div class="table-responsive col-12 barra_navegacion">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="registrarInstructor">Registrar Instructor</a>
            </li>
        </ol>
  </div>
            ...
            <div class="col-12">
                <div class="formulario_empresa animated bounceInUp">
                    <fieldset class="fieldset">
                        <legend class="text-center">Datos del Instructor</legend>
                        <form enctype="multipart/form-data" action="" method="POST" id="formadd">
                            ...
                            <a href="registrarInstructor" class="btn btn-danger izq" id="btn2">Cancelar </a>
                            <br>
                        </form>
                    </fieldset>
                </div>
