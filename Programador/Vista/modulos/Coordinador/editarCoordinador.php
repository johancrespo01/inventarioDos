...
if (isset($_POST['detalleClases'])) {
  ...
  $id_CoordinadorA = $modificar->id_Coordinador;
    #echo $id_CoordinadorA;
}

$CoordinadorActual = $int->mostrarCoordinadorActualControl();
?>
        ...
        <div class="container-fluid">
          <div class="row">
            <form enctype="multipart/form-data" action="" method="POST" id="formadd" style="width: 100%;">
              <input type="hidden" name="id_coordinador" value="<?php echo $id_CoordinadorA ?>">
                            <div class="form-group">                                        
                                ...
                                <select class="selectpicker form-control" data-live-search="true" name="tipoD">
                                  <option style="display: none"><?php echo $CoordinadorActual[0]['tipoDocumento'] ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input name="numero_documento" type="number" class="form-control" id="numDoc" placeholder="Document number" required value="<?php echo $CoordinadorActual[0]['numeroDocumento'] ?>">
                            </div>

                            <!--Contacto-->
                            <div class="form-group">
                                <label for="formGroupExampleInput">Nombres</label>
                                <input  type="text" class="form-control text_max" name="nombre_user" id="nombre_user" placeholder="Name" required value="<?php echo $CoordinadorActual[0]['nombre'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Apellidos</label>
                                <input  type="text" class="form-control text_max2" name="apellido_user" id="apellido_user" placeholder="Last name" required value="<?php echo $CoordinadorActual[0]['apellido'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Correo</label>
                                <input  type="mail" class="form-control" name="correo_user" id="correo_user" placeholder="Mail" required value="<?php echo $CoordinadorActual[0]['correo'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Telefono</label>
                                <input  type="number" class="form-control num_max" name="telefono_user" id="telefono_user" placeholder="Phone" required value="<?php echo $CoordinadorActual[0]['telefono'] ?>">
                            </div>  
                            <input type="submit" value="Modificar" class="btn btn-primary float-right" id="btn2">
                            <a href="tablaCoordinador" class="btn btn-danger izq" id="btn2">Cancelar </a>
                            <br>
                        </form>
          </div>
        </div>
