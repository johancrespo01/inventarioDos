 ...
 ?>
    ...
    <div class="table-responsive col-12 barra_navegacion">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="tablaCoordinador">Registros de Coordinadores</a>
            </li>
        </ol>
  </div>
            ...
            <div class="col-12">
                <div class="formulario_empresa">
                    ...
                    <fieldset class="fieldset">
                       <legend class="text-center">Datos del los Coordinador</legend>
                       <div class="tablaDiseño animated flipInX">
                        <div id="datos"></div>
                     	<table id="buscarExt" class="responsive table text-center display table-striped table-bordered table-sm tablaA1 tabla1" style="width:100%" cellspacing="0" width="100%">
		                    <thead>
		                        <tr>
		                    <br>
                    ...
                    <?php
                    $inicial = ControlCoordinador::singleton_Coordinador();
                    $limitado = $inicial->mostrarLimitadoCoordinador();
                    #var_dump($resultado);
                    #exit();
                    ...
                    foreach ($limitado as $key) {
                        ...
                        //Mostramos la empresa segun el id del Coordinador
                        #$name_empresa = $empresa->BuscarEmpresaControl($key['id_empresa']);
                        ?>
                        <tr id="Elemento<?php echo $id_Coordinador; ?>">
                           <td class="text-center">
                                </td>

                            <td class="text-center">
                               <!--ESTE ES EL BOTON QUE REALIZA LA ELIMINACION-->
                                <a class="btn btn-danger btnEliminar" value="<?php echo $id_Coordinador ?>" style="color:white;">
                                    <i class="fa fa-trash" id="icon"></i>
                                </a>
                                <!--ESTE ES EL BOTON QUE REALIZA LA EDICION-->
                                <a class="btn btn-primary btneditar" value="<?php echo $id_Coordinador ?>" style="color:white;">
...
if (isset($_POST['numero_documento'])) {
    //echo "<script>alert('Nsds ')</script>";
    $intContact = ControlCoordinador::singleton_Coordinador();
    $intContact->editarCoordinador();
} else {
