...
require_once CONTROL_PATH . 'categorias' . DS . 'ControlLaboratorio.php';
$resultado = ControlLaboratorio::singleton_laboratorio();
$resultado = $resultado->tiempoRealLaboratorioControl();
?>

<fieldset class="fieldset">
    <div id="datos"></div>
    <div class="tablaDiseño animated flipInX">
        <table id="tablaLaboratorio" class="responsive table text-center table-striped table-bordered table-sm tabla1" cellspacing="0" width="100%">
            <thead>
                <tr>
                   <br>
