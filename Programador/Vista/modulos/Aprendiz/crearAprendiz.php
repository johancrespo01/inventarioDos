            ...
            <div class="col-12">
                <div class="formulario_empresa animated bounceInUp">
                    <fieldset class="fieldset">
                        <legend class="text-center">Datos del Aprendiz</legend>
                        <form enctype="multipart/form-data" action="" method="POST" id="formadd">
                            ...
                            <div class="form-group animated zoomInUp">
                                ...
                                <input name="numero_documento" type="number" class="form-control soloNumeros" id="numDoc" placeholder="Document number" required>
                            </div>

                            <!--Contacto-->
                            <div class="form-group animated zoomInUp">
                                <label for="formGroupExampleInput">Nombres</label>
                                <input  type="text" class="form-control text_max soloLetras" name="nombre_user" id="nombre_user" placeholder="Name" required>
                            </div>
                            <div class="form-group animated zoomInUp">
                                <label for="formGroupExampleInput2">Apellidos</label>
                                <input  type="text" class="form-control text_max2 soloLetras" name="apellido_user" id="apellido_user" placeholder="Last name" required>
                            </div>
                            <div class="form-group animated zoomInUp">
                            ...
                            <div class="form-group animated zoomInUp">
                                ...
                                <input  type="number" class="form-control num_max soloNumeros" name="telefono_user" id="telefono_user" placeholder="Phone" required>
                            </div>  
...
if (isset($_POST['nombre_user'])) {
    $intContact = ControlAprendiz::singleton_aprendiz();
    $intContact->nuevoAprendiz();
} else {
