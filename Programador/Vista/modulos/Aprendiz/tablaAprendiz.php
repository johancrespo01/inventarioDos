...
require_once CONTROL_PATH . 'Aprendiz/ControlAprendiz.php';
$objss = new Session;
$objss->iniciar();
  ...
  <div id="content">
    ...
    <div class="table-responsive col-12 barra_navegacion">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="tablaAprendiz">Registros de Aprendices</a>
        </li>
      </ol>
    </div>
        ...
        <div class="col-12">
          <div class="formulario_empresa">
            ...
            <fieldset class="fieldset">
             <legend class="text-center">Datos del los aprendiz</legend>
             <div id="tablaDiseño" class="tablaDiseño animated flipInX">
              <div id="datos"></div>
              <table id="buscarExt" class="responsive table text-center display table-striped table-bordered table-sm tablaA1" style="width:100%" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                  $inicial = ControlAprendiz::singleton_aprendiz();
                  $limitado = $inicial->mostrarLimitadoAprendiz();
                    #var_dump($resultado);
                    #exit();
