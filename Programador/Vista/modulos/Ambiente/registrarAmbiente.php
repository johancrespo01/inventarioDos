                ...
                <div class="formulario_empresa animated bounceInUp">
                    <fieldset class="fieldset">
                        ...
                        <form enctype="multipart/form-data" action="" method="POST" id="formadd">
                                    ...
                                    <select class="selectpicker form-control" data-live-search="true" name="programa">
                                        ...
                                        if ($resultado == null) {
                                            echo '<script>
                                                       swal({
                                                         title: "Oops!",
                                                         text: "Antes de registrar un ambiente debe existir un programa",
                                                         icon: "error"
                                                         }).then((willDelete) => {
                                                          if (willDelete) {
                                                            window.location.replace("../Programa/registrarPrograma");
                                                          }else{
                            ...
                            <a href="registrarAmbiente" class="btn btn-danger izq" id="btn2">Cancelar </a>
                            <br>
                        </form>
                    </fieldset>
                </div>
